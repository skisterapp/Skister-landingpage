...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    .topnav { position: sticky; top: 0; z-index: 100; display:flex; align-items:center; justify-content:space-between; gap:1rem; padding: 1rem 0; margin-bottom: 0.5rem; background: rgba(10,10,10,0.92); backdrop-filter: blur(12px); border-bottom: 1px solid var(--border); }
    .topnav nav { display:flex; gap:1.25rem; align-items:center; }
    .topnav nav a { text-decoration:none; color:var(--muted); font-size: 0.95rem; transition: color 0.2s; }
    .topnav nav a:hover, .topnav nav a[aria-current="page"] { color:var(--text); }
    .brand { display:flex; align-items:center; text-decoration:none; }
    .logo-image { height: 2rem; width: auto; display: block; }
    .hero { padding: 1.5rem 0 1rem; }
    .hero h1 { margin:0 0 0.5rem; font-size:2.35rem; letter-spacing:-0.02em; background: linear-gradient(135deg, var(--accent), var(--accent-light)); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
    .hero p { margin:0; color:var(--muted); max-width: 62ch; line-height: 1.65; font-size: 1.05rem; }
    .download-banner { margin-top: 1.25rem; padding: 1rem 1.15rem; border: 1px solid rgba(34,139,34,0.35); border-radius: 14px; background: linear-gradient(135deg, rgba(34,139,34,0.14), rgba(34,139,34,0.06)); display:flex; flex-wrap:wrap; align-items:center; justify-content:space-between; gap: 0.85rem 1.25rem; }
    .download-banner-copy { display:flex; align-items:center; gap: 0.85rem; min-width: 0; }
    .download-banner-icon { width: 44px; height: 44px; border-radius: 10px; flex-shrink: 0; object-fit: cover; border: 1px solid rgba(255,255,255,0.12); }
    .download-banner-text h2 { margin: 0 0 0.15rem; font-size: 1rem; font-weight: 700; }
    .download-banner-text p { margin: 0; color: var(--muted); font-size: 0.92rem; line-height: 1.45; }
    .download-banner-btn { display:inline-flex; align-items:center; gap: 0.4rem; padding: 0.65rem 1.1rem; border-radius: 999px; background: var(--accent); color: #fff; text-decoration:none; font-weight: 700; font-size: 0.92rem; white-space: nowrap; transition: background 0.2s, transform 0.2s; }
    .download-banner-btn:hover { background: var(--accent-light); transform: translateY(-1px); }
    ...
    .search input:focus { outline: none; border-color: rgba(34,139,34,0.55); }
    .pill-row { display:flex; flex-wrap:wrap; gap: 0.5rem; }
    .pill-row button { padding: 0.55rem 0.7rem; border-radius: 999px; border: 1px solid var(--border); background: rgba(255,255,255,0.03); color: var(--muted); cursor:pointer; font-weight: 600; font-size: 0.9rem; transition: background 0.2s, border-color 0.2s, color 0.2s; }
    .pill-row button:hover { color: var(--text); border-color: rgba(255,255,255,0.18); }
    ...
    .grid { margin-top: 1.25rem; display:grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 1.25rem; }
    .article-card { border: 1px solid var(--border); border-radius: 16px; overflow:hidden; background: rgba(255,255,255,0.02); transition: transform 0.2s ease, border-color 0.2s ease, box-shadow 0.2s ease; height: 100%; }
    .article-card:hover { transform: translateY(-3px); border-color: rgba(34,139,34,0.45); box-shadow: 0 12px 32px rgba(34,139,34,0.12); }
    .article-card-link { text-decoration:none; display:flex; flex-direction:column; height: 100%; color: inherit; }
    .article-card-media { width: 100%; aspect-ratio: 16 / 10; background:#111; overflow:hidden; display:flex; align-items:center; justify-content:center; flex-shrink: 0; }
    .article-card-media img { width:100%; height:100%; object-fit:cover; display:block; transition: transform 0.35s ease; }
    .article-card:hover .article-card-media img { transform: scale(1.03); }
    .article-card-media-placeholder { color: var(--muted); font-size: 0.85rem; padding: 1rem; min-height: 180px; display:flex; align-items:center; justify-content:center; width: 100%; }
    .article-card-body { padding: 1rem 1.05rem 1.15rem; display:flex; flex-direction:column; flex: 1; }
    .article-card-meta { color: var(--muted); font-size: 0.85rem; display:flex; gap:0.5rem; align-items:center; margin-bottom: 0.4rem; flex-wrap: wrap; }
    .dot { opacity: 0.7; }
    .article-card-title { margin: 0; font-size: 1.05rem; line-height: 1.35; letter-spacing:-0.01em; display:-webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow:hidden; }
    .article-card-excerpt { margin: 0.45rem 0 0.85rem; color: var(--muted); line-height: 1.55; font-size: 0.95rem; display:-webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow:hidden; flex: 1; }
    .article-card-cta { margin: 0; margin-top: auto; color: var(--accent); font-weight: 700; font-size: 0.95rem; }
    .blog-footer { margin-top: 3rem; padding-top: 1.5rem; border-top: 1px solid var(--border); color: var(--muted); font-size: 0.9rem; display:flex; flex-wrap:wrap; gap: 0.75rem 1.5rem; justify-content: space-between; align-items:center; }
...
<body>
  <div class="wrap">
    <header class="topnav">
      <a class="brand" href="../index.html" aria-label="Skister home">
        <img
          src="https://ayomhapkzckbhgwxenwr.supabase.co/storage/v1/object/public/SkisterApp/SkisterLogoWeb.png"
          alt="Skister"
          class="logo-image"
          width="1287"
          height="337"
    ...
    <aside class="download-banner" aria-label="Download Skister">
      <div class="download-banner-copy">
        <img class="download-banner-icon" src="../assets/skister-app-icon.png" alt="" width="44" height="44">
        <div class="download-banner-text">
          <h2>Share ski gear with your trusted network</h2>
          <p>Get Skister on iOS, Android, or the web — free, local, and family-friendly.</p>
        </div>
      </div>
      <a class="download-banner-btn" href="../index.html#download">Get the app →</a>
    </aside>
...
${allCardsHtml}
    ...
    <footer class="blog-footer">
      <span>© ${new Date().getFullYear()} Skister</span>
